...
const Navbar = () => {
  ...
  const [isRatingDropdownInvoice, setIsRatingDropdownInvoice] = useState(true);
  const [isRatingDropdownStorage, setIsRatingDropdownStorage] = useState(true);
  ...
  const toggleRatingDropdown1 = () => {
    setIsRatingDropdownInvoice(!isRatingDropdownInvoice);
  };
  const toggleRatingDropdown2 = () => {
    setIsRatingDropdownStorage(!isRatingDropdownStorage);
  };
    ...
    <div>
      ...
      <div className="right">
        <div className="green-box">
          ...
          <div className="product">
            ...
            <div className='redmi'>
           <span>
              <h2><FavoriteBorderIcon/> &nbsp;REDMI NOTE 11 PRO(Stealth Black,128GB)</h2></span>
              <div className="side">
          ...
          <div className="product">
            ...
            <div className='redmi'>
              <h2><FavoriteBorderIcon/> &nbsp; REDMI NOTE 11 PRO(Stealth Black,128GB)</h2>
              <div className="side">
              <span className='star'>4.2 star</span> &nbsp;
              1585 Ratings & 108 Reviews
              <ul>
      ...
      <div className='left'>
        ...
        <div className="dropdown-container" >
          ...
          <span className="dropdown-symbol-rate" onClick={toggleRatingDropdown}>{isRatingDropdownVisible ? '∧' : 'v'}</span>
        ...
        <div className='Invoice'>
          ...
          <span className="dropdown-symbol" onClick={toggleRatingDropdown1}>{isRatingDropdownInvoice ? '∧' : 'v'}</span></div>
          {isRatingDropdownInvoice && (
        ...
        <div className="storage">
          ...
          <span className="dropdown-symbol" onClick={toggleRatingDropdown2}>{isRatingDropdownStorage ? '∧' : 'v'}</span></div>
          {isRatingDropdownStorage && (
